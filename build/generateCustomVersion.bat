...
set applicationName=RzR.Web.Middleware.ETag
...
set packResultPath=$('..\nuget\')
set packProjectsPath=$('..\src\ETagMW\ETagMW.csproj')
set testProjectsPath=$('..\src\tests\ETagMW.Tests\ETagMW.Tests.csproj')
